...
for(let i =0; i< planeta.collection.items.length; i++){
    const imagen = planeta.collection.items[i].links?.[0].href || 'https://static.vecteezy.com/system/resources/previews/010/427/108/large_2x/world-planet-earth-silhouette-free-vector.jpg'
